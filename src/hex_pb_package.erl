...
get_msg_containment("hex_pb_package") -> ['AdvisoryReference', 'Dependency', 'Package', 'Release', 'RetirementStatus', 'SecurityAdvisory', 'Timestamp'];
...
get_proto_by_msg_name_as_fqbin(<<"AdvisoryReference">>) -> "hex_pb_package";
